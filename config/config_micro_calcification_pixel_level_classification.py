...
__C.general.saving_dir = '/data/lars/models/20190926_uCs_pixel_level_classification_CE_default_dilation_radius_7/'
__C.general.cuda_device_idx = '6'  # specify the index of the gpu devices to be occupied
