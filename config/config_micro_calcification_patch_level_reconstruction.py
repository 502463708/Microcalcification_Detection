...
# general parameters
__C.general = {}
__C.general.data_root_dir = '/data/lars/data/Inbreat_patch_splitted_10_16_new'
__C.general.saving_dir = '/data/lars/models/20191017_uCs_reconstruction_ttestlossv3_default_dilation_radius_7/'
