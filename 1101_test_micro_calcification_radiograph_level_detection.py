...
def ParseArguments():
    ...
    parser.add_argument('--data_root_dir',
                        type=str,
                        default='/home/groupprofzli/data1/dwz/data/Inbreast-radiograph-level-roi-extracted-data-split-dataset',
    ...
    parser.add_argument('--prediction_saving_dir',
                        type=str,
                        default='/home/groupprofzli/data1/dwz/results/micro_calcification_radiograph_level_detection_results_1101/',
                        help='The predicted results saving dir.')
    parser.add_argument('--reconstruction_model_saving_dir',
                        type=str,
                        default='/home/groupprofzli/data1/dwz/data/models/20191025_uCs_reconstruction_ttestlossv3_default_dilation_radius_7',
    ...
    parser.add_argument('--classification_model_saving_dir',
                        type=str,
                        default='/home/groupprofzli/data1/dwz/data/models/20191025_uCs_image_level_classification_CE_default',
