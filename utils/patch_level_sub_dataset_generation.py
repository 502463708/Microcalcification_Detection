...
def filename_list_split(src_dataset_type_dir, sub_dataset_number, patch_type, random_seed, logger=None):
    ...
    if logger is None:
        print('*******************************************************************************************************')
        print('Source {} dataset contains {} {}.'.format(dataset_type, image_num, patch_type))
    else:
        logger.write_and_print('**************************************************************************************')
        logger.write_and_print('Source {} dataset contains {} {}.'.format(dataset_type, image_num, patch_type))
...
def copy_data_from_src_2_dst(src_dataset_type_dir, dst_dataset_type_dir, sub_filename_list, sub_dataset_idx,
                             dataset_type, patch_type, logger=None):
    assert os.path.exists(src_dataset_type_dir)
